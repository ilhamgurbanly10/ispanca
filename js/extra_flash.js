...
function flash_first_type_slide(container, autoplay = false, time = "very-slow") {
	...
	var containers = container.querySelectorAll('.flash-first-type-slide-text-con');
	...
	function active(index) {
		...
		for (var i = 0; i < images.length; i++) {
			...
			if (index == i) { 
				...
				containers[i].classList.add('active-slide-element'); 
				...
				containers[i].classList.remove('active-slide-element');
